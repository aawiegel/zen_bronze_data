...
- ❌ **Use em dashes sparingly** (limit to 1 set per post max, and even then consider transition words, periods, semicolons, or parentheses instead)
...
- **Em dashes:** **VERY RARELY** (use transition words, periods, semicolons, or parentheses instead, one per post max)
...
- [ ] Minimal use of em dashes (1-2 max per post, but consider editing out even then)
